...
// Space utilization statistics for the volume.
type SpaceUtilizationStats struct {
...
// Block device statistics for the volume.
type BlockDeviceStats struct {
	// Apple contains statistics specific to Apple block storage drivers.
	//
	// This field is populated only for volumes on Apple platforms that use block storage drivers.
	Apple *BlockDeviceStatsApple
	// Linux contains statistics specific to Linux block devices.
	//
	// This field is populated only for volumes on Linux platforms.
	Linux *BlockDeviceStatsLinux
}

// Statistics from IOKit block storage drivers on Apple platforms.
type BlockDeviceStatsApple struct {
...
type BlockDeviceStatsLinux struct {
