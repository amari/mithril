...
type NodeSeedGenerator struct{}

var _ domain.NodeSeedGenerator = (*NodeSeedGenerator)(nil)

func NewNodeSeedGenerator() *NodeSeedGenerator {
	return &NodeSeedGenerator{}
}

func (g *NodeSeedGenerator) Generate() (domain.NodeSeed, error) {
